...
def welcome_message() -> str:
    return (
        ...
        "Помогу со стандартными вопросами авторов, сделаю техническую предпроверку рукописи "
        "(символы, слова, разделы) и при необходимости передам обращение оператору.\n\n"
        "Я не принимаю статьи и не выношу решение о публикации — только поддержка и первичный техскрининг."
    )
